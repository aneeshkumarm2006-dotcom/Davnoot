 ...
 */
import { esc, navHtml, footerHtml, FAVICON_TAGS, ANALYTICS_TAGS } from './templates.js';
...
const DESTINATIONS = [
  ...
  { num: '03 · Google Ads', href: '/services/google-ads', title: 'Buy the clicks that <em>convert</em>', arrow: 'Explore' },
