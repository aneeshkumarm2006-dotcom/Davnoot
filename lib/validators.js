...
export const categoryCreateSchema = z
  .object({
    ...
    slug: optStr(96),
    // `description` is the archive page's only real copy. Before it existed, every
    // /blog/category/<slug> was an H1, a one-line generated subhead, and a card grid
    // — under 200 words, which is what the 2026-08-01 Semrush audit flagged as
    // "Low word count" on all six archives at once. Optional, so a category created
    // without one still works exactly as before (the renderer falls back).
