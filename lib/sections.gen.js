...
// Root-absolute, and EXTENSIONLESS. A relative "book-call.html" default resolved
// against a composed page's clean URL (/some-page) and landed on the /book-call.html
// 301 — a redirect hop on the primary CTA of every section the author left blank.
const href = (fields, key, fallback = '/book-call') => {
