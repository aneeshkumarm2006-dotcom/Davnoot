...
const PAGE = {
  ...
  'tools.html': ['Free tools', 'Free, no-signup marketing tools — a content analyzer that runs entirely in the visitor’s browser, and a free site audit a person on the team writes by hand'],
  'site-audit.html': ['Free Site Audit', 'Request a free website audit — a person on the team reviews organic search and keyword gaps, crawlability and indexation, landing page messaging, paid ad spend, conversion tracking and AI search visibility, then emails the findings within three business days. Not an automated crawl.'],
